...
list_groups_command = {
    "commands": [{"command": "listGroups", "verbose": False, "correlationData": "10"}]
}
list_groups_response = {
    "responses": [
        {
            "command": "listGroups",
            "data": {"totalCount": 2, "groups": ["group_one", "group_two"]},
            "correlationData": "10",
        }
    ]
}
...
list_groups_verbose_command = {
    "commands": [{"command": "listGroups", "verbose": True, "correlationData": "15"}]
}
                ...
                "groups": [
                    {
                        ...
                        "textname": "Name",
                        "textdescription": "description",
                        "clients": [{"username": "user_one"}, {"username": "user_two"}],
                        "roles": [],
                    },
                    {
                        "groupname": "group_two",
...
add_client_to_group_response = {
    "responses": [{"command": "addGroupClient", "correlationData": "1234"}]
}
add_duplicate_client_to_group_response = {
    "responses": [
        {
            "command": "addGroupClient",
...
add_client_to_group2_response = {
    "responses": [{"command": "addGroupClient", "correlationData": "1234"}]
}

add_client2_to_group_command = {
    "commands": [
        {
            "command": "addGroupClient",
            "username": "user_two",
            "groupname": "group_one",
            "correlationData": "1235",
        }
    ]
}
add_client2_to_group_response = {
    "responses": [{"command": "addGroupClient", "correlationData": "1235"}]
}

remove_client_from_group_command = {
    "commands": [
        {
...
remove_client_from_group_response = {
    "responses": [{"command": "removeGroupClient", "correlationData": "4321"}]
}

delete_group_command = {
    "commands": [{"command": "deleteGroup", "groupname": "group_one", "correlationData": "5678"}]
}
