...
create_client1_response = {
    "responses": [{"command": "createClient", "error": "Invalid/missing username"}]
}

# Username not a string
create_client2_command = {"commands": [{"command": "createClient", "username": 5}]}
create_client2_response = {
    "responses": [{"command": "createClient", "error": "Invalid/missing username"}]
}

# Username not UTF-8
create_client3_command = {"commands": [{"command": "createClient", "username": "￿LO"}]}
create_client3_response = {
    "responses": [{"command": "createClient", "error": "Username not valid UTF-8"}]
}

# Password not a string
create_client4_command = {
    "commands": [{"command": "createClient", "username": "user", "password": 5}]
}
create_client4_response = {
    "responses": [{"command": "createClient", "error": "Invalid/missing password"}]
}

# Client id not a string
create_client5_command = {
    "commands": [{"command": "createClient", "username": "user", "password": "5", "clientid": 5}]
}
create_client5_response = {
    "responses": [{"command": "createClient", "error": "Invalid/missing client id"}]
}

# Client id not UTF-8
create_client6_command = {
    "commands": [{"command": "createClient", "username": "user", "clientid": "￿LO"}]
}
create_client6_response = {
    "responses": [{"command": "createClient", "error": "Client ID not valid UTF-8"}]
}

# Text name not a string
create_client7_command = {
    "commands": [{"command": "createClient", "username": "user", "password": "5", "textname": 5}]
}
create_client7_response = {
    "responses": [{"command": "createClient", "error": "Invalid/missing textname"}]
}

# Text description not a string
create_client8_command = {
    "commands": [
        {
...
create_client8_response = {
    "responses": [{"command": "createClient", "error": "Invalid/missing textdescription"}]
}

# Client already exists
create_client9_command = {
    "commands": [{"command": "createClient", "username": "admin", "password": "5"}]
}
create_client9_response = {
    "responses": [{"command": "createClient", "error": "Client already exists"}]
}

# Roles not an array
create_client10_command = {
    "commands": [{"command": "createClient", "username": "user", "password": "5", "roles": "bad"}]
}
create_client10_response = {
    "responses": [
        {
            "command": "createClient",
            "error": "'roles' not an array or missing/invalid rolename",
        }
    ]
}

# Role not found
create_client11_command = {
    "commands": [
        {
            "command": "createClient",
            "username": "user",
            "password": "5",
            "roles": [{"rolename": "notfound"}],
        }
    ]
}
...
# Group not found
create_client12_command = {
    "commands": [
        {
            "command": "createClient",
            "username": "user",
            "password": "5",
            "groups": [{"groupname": "notfound"}],
        }
    ]
}
...
delete_client1_response = {
    "responses": [{"command": "deleteClient", "error": "Invalid/missing username"}]
}

# Username not a string
delete_client2_command = {"commands": [{"command": "deleteClient", "username": 5}]}
delete_client2_response = {
    "responses": [{"command": "deleteClient", "error": "Invalid/missing username"}]
}

# Username not UTF-8
delete_client3_command = {"commands": [{"command": "deleteClient", "username": "￿LO"}]}
delete_client3_response = {
    "responses": [{"command": "deleteClient", "error": "Username not valid UTF-8"}]
}
...
disable_client1_response = {
    "responses": [{"command": "disableClient", "error": "Invalid/missing username"}]
}
...
disable_client3_response = {
    "responses": [{"command": "disableClient", "error": "Username not valid UTF-8"}]
}

# Client not found
disable_client4_command = {"commands": [{"command": "disableClient", "username": "notfound"}]}
disable_client4_response = {
    "responses": [{"command": "disableClient", "error": "Client not found"}]
}
...
enable_client1_response = {
    "responses": [{"command": "enableClient", "error": "Invalid/missing username"}]
}

# Username not a string
enable_client2_command = {"commands": [{"command": "enableClient", "username": 5}]}
enable_client2_response = {
    "responses": [{"command": "enableClient", "error": "Invalid/missing username"}]
}

# Username not UTF-8
enable_client3_command = {"commands": [{"command": "enableClient", "username": "￿LO"}]}
enable_client3_response = {
    "responses": [{"command": "enableClient", "error": "Username not valid UTF-8"}]
}
...
set_client_id1_response = {
    "responses": [{"command": "setClientId", "error": "Invalid/missing username"}]
}

# Username not a string
set_client_id2_command = {"commands": [{"command": "setClientId", "username": 5}]}
set_client_id2_response = {
    "responses": [{"command": "setClientId", "error": "Invalid/missing username"}]
}

# Username not UTF-8
set_client_id3_command = {"commands": [{"command": "setClientId", "username": "￿LO"}]}
set_client_id3_response = {
    "responses": [{"command": "setClientId", "error": "Username not valid UTF-8"}]
}
...
# Client id not a string
set_client_id5_command = {
    "commands": [{"command": "setClientId", "username": "user", "clientid": 5}]
}
set_client_id5_response = {
    "responses": [{"command": "setClientId", "error": "Invalid/missing client ID"}]
}

# Client id not UTF-8
set_client_id6_command = {
    "commands": [{"command": "setClientId", "username": "user", "clientid": "￿LO"}]
}
set_client_id6_response = {
    "responses": [{"command": "setClientId", "error": "Client ID not valid UTF-8"}]
}

# Client not found
set_client_id7_command = {
    "commands": [{"command": "setClientId", "username": "notfound", "clientid": "newid"}]
}
...
set_password1_response = {
    "responses": [{"command": "setClientPassword", "error": "Invalid/missing username"}]
}

# Username not a string
set_password2_command = {"commands": [{"command": "setClientPassword", "username": 5}]}
set_password2_response = {
    "responses": [{"command": "setClientPassword", "error": "Invalid/missing username"}]
}

# Username not UTF-8
set_password3_command = {"commands": [{"command": "setClientPassword", "username": "￿LO"}]}
set_password3_response = {
    "responses": [{"command": "setClientPassword", "error": "Username not valid UTF-8"}]
}

# No password
set_password4_command = {"commands": [{"command": "setClientPassword", "username": "user"}]}
set_password4_response = {
    "responses": [{"command": "setClientPassword", "error": "Invalid/missing password"}]
}

# password not a string
set_password5_command = {
    "commands": [{"command": "setClientPassword", "username": "user", "password": 5}]
}
set_password5_response = {
    "responses": [{"command": "setClientPassword", "error": "Invalid/missing password"}]
}

# password is empty
set_password6_command = {
    "commands": [{"command": "setClientPassword", "username": "user", "password": ""}]
}
set_password6_response = {
    "responses": [{"command": "setClientPassword", "error": "Empty password is not allowed"}]
}

# Client not found
set_password7_command = {
    "commands": [{"command": "setClientPassword", "username": "notfound", "password": "newpw"}]
}
set_password7_response = {
    "responses": [{"command": "setClientPassword", "error": "Client not found"}]
}
...
get_client1_response = {
    "responses": [{"command": "getClient", "error": "Invalid/missing username"}]
}

# Username not a string
get_client2_command = {"commands": [{"command": "getClient", "username": 5}]}
get_client2_response = {
    "responses": [{"command": "getClient", "error": "Invalid/missing username"}]
}

# Username not UTF-8
get_client3_command = {"commands": [{"command": "getClient", "username": "￿LO"}]}
get_client3_response = {
    "responses": [{"command": "getClient", "error": "Username not valid UTF-8"}]
}
...
add_role1_response = {
    "responses": [{"command": "addClientRole", "error": "Invalid/missing username"}]
}
...
add_role3_response = {
    "responses": [{"command": "addClientRole", "error": "Username not valid UTF-8"}]
}

# No rolename
add_role4_command = {"commands": [{"command": "addClientRole", "username": "user"}]}
add_role4_response = {
    "responses": [{"command": "addClientRole", "error": "Invalid/missing rolename"}]
}
...
# rolename not UTF-8
add_role6_command = {
    "commands": [{"command": "addClientRole", "username": "user", "rolename": "￿LO"}]
}
add_role6_response = {
    "responses": [{"command": "addClientRole", "error": "Role name not valid UTF-8"}]
}

# Client not found
add_role7_command = {
    "commands": [{"command": "addClientRole", "username": "notfound", "rolename": "notfound"}]
}
add_role7_response = {"responses": [{"command": "addClientRole", "error": "Client not found"}]}

# Role not found
add_role8_command = {
    "commands": [{"command": "addClientRole", "username": "admin", "rolename": "notfound"}]
}
...
remove_role1_response = {
    "responses": [{"command": "removeClientRole", "error": "Invalid/missing username"}]
}

# Username not a string
remove_role2_command = {"commands": [{"command": "removeClientRole", "username": 5}]}
remove_role2_response = {
    "responses": [{"command": "removeClientRole", "error": "Invalid/missing username"}]
}
...
remove_role3_response = {
    "responses": [{"command": "removeClientRole", "error": "Username not valid UTF-8"}]
}

# No rolename
remove_role4_command = {"commands": [{"command": "removeClientRole", "username": "user"}]}
remove_role4_response = {
    "responses": [{"command": "removeClientRole", "error": "Invalid/missing rolename"}]
}

# rolename not a string
remove_role5_command = {
    "commands": [{"command": "removeClientRole", "username": "user", "rolename": 5}]
}
remove_role5_response = {
    "responses": [{"command": "removeClientRole", "error": "Invalid/missing rolename"}]
}

# rolename not UTF-8
remove_role6_command = {
    "commands": [{"command": "removeClientRole", "username": "user", "rolename": "￿LO"}]
}
remove_role6_response = {
    "responses": [{"command": "removeClientRole", "error": "Role name not valid UTF-8"}]
}

# Client not found
remove_role7_command = {
    "commands": [{"command": "removeClientRole", "username": "notfound", "rolename": "notfound"}]
}
remove_role7_response = {
    "responses": [{"command": "removeClientRole", "error": "Client not found"}]
}

# Role not found
remove_role8_command = {
    "commands": [{"command": "removeClientRole", "username": "admin", "rolename": "notfound"}]
}
...
modify_client1_response = {
    "responses": [{"command": "modifyClient", "error": "Invalid/missing username"}]
}

# Username not a string
modify_client2_command = {"commands": [{"command": "modifyClient", "username": 5}]}
modify_client2_response = {
    "responses": [{"command": "modifyClient", "error": "Invalid/missing username"}]
}

# Username not UTF-8
modify_client3_command = {"commands": [{"command": "modifyClient", "username": "￿LO"}]}
modify_client3_response = {
    "responses": [{"command": "modifyClient", "error": "Username not valid UTF-8"}]
}

# roles not a list
modify_client4_command = {
    "commands": [
        {
...
# No rolename
modify_client5_command = {
    "commands": [{"command": "modifyClient", "username": "user", "roles": [{"rolename": 5}]}]
}
modify_client5_response = {
    "responses": [
        {
            "command": "modifyClient",
            "error": "'roles' not an array or missing/invalid rolename",
...
# Client not found
modify_client7_command = {
    "commands": [{"command": "modifyClient", "username": "notfound", "rolename": "notfound"}]
}
modify_client7_response = {"responses": [{"command": "modifyClient", "error": "Client not found"}]}

# Role not found
modify_client8_command = {
    "commands": [
        {
            "command": "modifyClient",
            "username": "user",
