    ...
    try:
        ...
        if expect_deny:
            ...
            mosq_test.receive_unordered(
                sock, puback1s_packet, publish1r_packet, "puback / publish1r"
            )
        sock.close()
