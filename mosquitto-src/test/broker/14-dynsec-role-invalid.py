...
create_role1_response = {
    "responses": [{"command": "createRole", "error": "Invalid/missing rolename"}]
}

# Rolename not a string
create_role2_command = {"commands": [{"command": "createRole", "rolename": 5}]}
create_role2_response = {
    "responses": [{"command": "createRole", "error": "Invalid/missing rolename"}]
}

# Rolename not UTF-8
create_role3_command = {"commands": [{"command": "createRole", "rolename": "￿LO"}]}
create_role3_response = {
    "responses": [{"command": "createRole", "error": "Role name not valid UTF-8"}]
}

# textname not a string
create_role4_command = {"commands": [{"command": "createRole", "rolename": "g", "textname": 5}]}
create_role4_response = {
    "responses": [{"command": "createRole", "error": "Invalid/missing textname"}]
}

# textdescription not a string
create_role5_command = {
    "commands": [{"command": "createRole", "rolename": "g", "textdescription": 5}]
}
create_role5_response = {
    "responses": [{"command": "createRole", "error": "Invalid/missing textdescription"}]
}
...
delete_role1_response = {
    "responses": [{"command": "deleteRole", "error": "Invalid/missing rolename"}]
}

# Rolename not a string
delete_role2_command = {"commands": [{"command": "deleteRole", "rolename": 5}]}
delete_role2_response = {
    "responses": [{"command": "deleteRole", "error": "Invalid/missing rolename"}]
}

# Rolename not UTF-8
delete_role3_command = {"commands": [{"command": "deleteRole", "rolename": "￿LO"}]}
delete_role3_response = {
    "responses": [{"command": "deleteRole", "error": "Role name not valid UTF-8"}]
}
...
add_role_acl1_response = {
    "responses": [{"command": "addRoleACL", "error": "Invalid/missing rolename"}]
}

add_role_acl2_command = {"commands": [{"command": "addRoleACL", "rolename": 5}]}
add_role_acl2_response = {
    "responses": [{"command": "addRoleACL", "error": "Invalid/missing rolename"}]
}

add_role_acl3_command = {"commands": [{"command": "addRoleACL", "rolename": "￿LO"}]}
add_role_acl3_response = {
    "responses": [{"command": "addRoleACL", "error": "Role name not valid UTF-8"}]
}
...
add_role_acl7_response = {
    "responses": [{"command": "addRoleACL", "error": "Invalid/missing topic"}]
}

add_role_acl8_command = {
    "commands": [
        {
            "command": "addRoleACL",
            "rolename": "validrole",
...
add_role_acl8_response = {
    "responses": [{"command": "addRoleACL", "error": "Invalid/missing topic"}]
}

add_role_acl9_command = {
    "commands": [
        {
            "command": "addRoleACL",
            "rolename": "validrole",
...
add_role_acl9_response = {
    "responses": [{"command": "addRoleACL", "error": "Topic not valid UTF-8"}]
}

add_role_acl10_command = {
    "commands": [
        {
            "command": "addRoleACL",
            "rolename": "validrole",
...
remove_role_acl1_response = {
    "responses": [{"command": "removeRoleACL", "error": "Invalid/missing rolename"}]
}

remove_role_acl2_command = {"commands": [{"command": "removeRoleACL", "rolename": 5}]}
remove_role_acl2_response = {
    "responses": [{"command": "removeRoleACL", "error": "Invalid/missing rolename"}]
}

remove_role_acl3_command = {"commands": [{"command": "removeRoleACL", "rolename": "￿LO"}]}
remove_role_acl3_response = {
    "responses": [{"command": "removeRoleACL", "error": "Role name not valid UTF-8"}]
}
...
remove_role_acl5_response = {
    "responses": [{"command": "removeRoleACL", "error": "Invalid/missing acltype"}]
}

remove_role_acl6_command = {
    "commands": [{"command": "removeRoleACL", "rolename": "validrole", "acltype": "notvalid"}]
}
remove_role_acl6_response = {
    "responses": [{"command": "removeRoleACL", "error": "Unknown acltype"}]
}

remove_role_acl7_command = {
    "commands": [
        {
...
remove_role_acl7_response = {
    "responses": [{"command": "removeRoleACL", "error": "Invalid/missing topic"}]
}

remove_role_acl8_command = {
    "commands": [
        {
            "command": "removeRoleACL",
            "rolename": "validrole",
...
remove_role_acl8_response = {
    "responses": [{"command": "removeRoleACL", "error": "Invalid/missing topic"}]
}

remove_role_acl9_command = {
    "commands": [
        {
            "command": "removeRoleACL",
            "rolename": "validrole",
...
remove_role_acl9_response = {
    "responses": [{"command": "removeRoleACL", "error": "Topic not valid UTF-8"}]
}
...
modify_group1_response = {
    "responses": [{"command": "modifyRole", "error": "Invalid/missing groupname"}]
}
...
modify_group3_response = {
    "responses": [{"command": "modifyRole", "error": "Role name not valid UTF-8"}]
}
...
modify_group5_command = {
    "commands": [{"command": "modifyRole", "groupname": "validgroup", "roles": [{}]}]
}
...
modify_group6_command = {
    "commands": [{"command": "modifyRole", "groupname": "validgroup", "roles": [{"rolename": 5}]}]
}
...
modify_group8_command = {
    "commands": [{"command": "modifyRole", "groupname": "notfound", "rolename": "notfound"}]
}
