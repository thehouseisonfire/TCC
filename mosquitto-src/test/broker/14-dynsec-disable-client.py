...
get_client_command = {"commands": [{"command": "getClient", "username": "user_one"}]}
...
disable_client_command = {"commands": [{"command": "disableClient", "username": "user_one"}]}
disable_client_response = {"responses": [{"command": "disableClient"}]}

enable_client_command = {"commands": [{"command": "enableClient", "username": "user_one"}]}
...
client_connect_packet = mosq_test.gen_connect(
    "cid", keepalive=keepalive, username="user_one", password="password"
)
...
try:
    ...
    client_sock = mosq_test.do_client_connect(
        client_connect_packet, client_connack_packet1, timeout=5, port=port
    )
    ...
    client_sock = mosq_test.do_client_connect(
        client_connect_packet, client_connack_packet2, timeout=5, port=port
    )
    client_sock.close()
