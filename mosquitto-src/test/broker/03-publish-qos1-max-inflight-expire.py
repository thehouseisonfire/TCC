...
def do_test(proto_ver):
    ...
    sub_connect_packet = mosq_test.gen_connect(
        "sub",
        keepalive=keepalive,
    ...
    sub_connack_packet = mosq_test.gen_connack(
        rc=0, proto_ver=proto_ver, properties=properties, property_helper=False
    )
    sub_connack_packet2 = mosq_test.gen_connack(
        rc=0, flags=1, proto_ver=proto_ver, properties=properties, property_helper=False
    )
    ...
    mid = 1
    r_publish_packet = mosq_test.gen_publish(
    ...
    try:
        sub_sock = mosq_test.do_client_connect(
            sub_connect_packet, sub_connack_packet, port=port, timeout=10
        )
        ...
        sub_sock = mosq_test.do_client_connect(
            sub_connect_packet, sub_connack_packet2, port=port, timeout=10
        )
        ...
        #
        mid = 1
        s_publish_packet = mosq_test.gen_publish(
            "pub/qos1/test", qos=1, mid=mid, payload="message2", proto_ver=proto_ver
        )
