...
create_group1_response = {
    "responses": [{"command": "createGroup", "error": "Invalid/missing groupname"}]
}
...
create_group3_response = {
    "responses": [{"command": "createGroup", "error": "Group name not valid UTF-8"}]
}

# textname not a string
create_group4_command = {"commands": [{"command": "createGroup", "groupname": "g", "textname": 5}]}
create_group4_response = {
    "responses": [{"command": "createGroup", "error": "Invalid/missing textname"}]
}

# textdescription not a string
create_group5_command = {
    "commands": [{"command": "createGroup", "groupname": "g", "textdescription": 5}]
}
create_group5_response = {
    "responses": [{"command": "createGroup", "error": "Invalid/missing textdescription"}]
}

# Group already exists
create_group6_command = {"commands": [{"command": "createGroup", "groupname": "validgroup"}]}
create_group6_response = {
    "responses": [{"command": "createGroup", "error": "Group already exists"}]
}

# Role not found
create_group7_command = {
    "commands": [
        {
            "command": "createGroup",
            "groupname": "group",
...
delete_group1_response = {
    "responses": [{"command": "deleteGroup", "error": "Invalid/missing groupname"}]
}

# Groupname not a string
delete_group2_command = {"commands": [{"command": "deleteGroup", "groupname": 5}]}
delete_group2_response = {
    "responses": [{"command": "deleteGroup", "error": "Invalid/missing groupname"}]
}

# Groupname not UTF-8
delete_group3_command = {"commands": [{"command": "deleteGroup", "groupname": "￿LO"}]}
delete_group3_response = {
    "responses": [{"command": "deleteGroup", "error": "Group name not valid UTF-8"}]
}
...
add_role1_response = {
    "responses": [{"command": "addGroupRole", "error": "Invalid/missing groupname"}]
}
...
add_role3_response = {
    "responses": [{"command": "addGroupRole", "error": "Group name not valid UTF-8"}]
}

# No rolename
add_role4_command = {"commands": [{"command": "addGroupRole", "groupname": "g"}]}
add_role4_response = {
    "responses": [{"command": "addGroupRole", "error": "Invalid/missing rolename"}]
}
...
add_role6_response = {
    "responses": [{"command": "addGroupRole", "error": "Role name not valid UTF-8"}]
}

# Group not found
add_role7_command = {
    "commands": [{"command": "addGroupRole", "groupname": "notfound", "rolename": "notfound"}]
}
add_role7_response = {"responses": [{"command": "addGroupRole", "error": "Group not found"}]}

# Role not found
add_role8_command = {
    "commands": [{"command": "addGroupRole", "groupname": "validgroup", "rolename": "notfound"}]
}
...
remove_role1_response = {
    "responses": [{"command": "removeGroupRole", "error": "Invalid/missing groupname"}]
}
...
remove_role3_response = {
    "responses": [{"command": "removeGroupRole", "error": "Group name not valid UTF-8"}]
}

# No rolename
remove_role4_command = {"commands": [{"command": "removeGroupRole", "groupname": "g"}]}
remove_role4_response = {
    "responses": [{"command": "removeGroupRole", "error": "Invalid/missing rolename"}]
}

# Rolename not a string
remove_role5_command = {
    "commands": [{"command": "removeGroupRole", "groupname": "g", "rolename": 5}]
}
...
remove_role6_command = {
    "commands": [{"command": "removeGroupRole", "groupname": "g", "rolename": "￿LO"}]
}
remove_role6_response = {
    "responses": [{"command": "removeGroupRole", "error": "Role name not valid UTF-8"}]
}

# Group not found
remove_role7_command = {
    "commands": [{"command": "removeGroupRole", "groupname": "notfound", "rolename": "notfound"}]
}
...
add_client1_response = {
    "responses": [{"command": "addGroupClient", "error": "Invalid/missing groupname"}]
}

# Groupname not a string
add_client2_command = {"commands": [{"command": "addGroupClient", "groupname": 5, "username": "g"}]}
add_client2_response = {
    "responses": [{"command": "addGroupClient", "error": "Invalid/missing groupname"}]
}

# Groupname not UTF-8
add_client3_command = {
    "commands": [{"command": "addGroupClient", "groupname": "￿LO", "username": "g"}]
}
add_client3_response = {
    "responses": [{"command": "addGroupClient", "error": "Group name not valid UTF-8"}]
}

# No username
add_client4_command = {"commands": [{"command": "addGroupClient", "groupname": "g"}]}
add_client4_response = {
    "responses": [{"command": "addGroupClient", "error": "Invalid/missing username"}]
}

# Username not a string
add_client5_command = {"commands": [{"command": "addGroupClient", "groupname": "g", "username": 5}]}
add_client5_response = {
    "responses": [{"command": "addGroupClient", "error": "Invalid/missing username"}]
}

# Username not UTF-8
add_client6_command = {
    "commands": [{"command": "addGroupClient", "groupname": "g", "username": "￿LO"}]
}
add_client6_response = {
    "responses": [{"command": "addGroupClient", "error": "Username not valid UTF-8"}]
}
...
# Client not found
add_client8_command = {
    "commands": [{"command": "addGroupClient", "groupname": "validgroup", "username": "notfound"}]
}
...
remove_client1_response = {
    "responses": [{"command": "removeGroupClient", "error": "Invalid/missing groupname"}]
}

# Groupname not a string
remove_client2_command = {
    "commands": [{"command": "removeGroupClient", "groupname": 5, "username": "g"}]
}
remove_client2_response = {
    "responses": [{"command": "removeGroupClient", "error": "Invalid/missing groupname"}]
}

# Groupname not UTF-8
remove_client3_command = {
    "commands": [{"command": "removeGroupClient", "groupname": "￿LO", "username": "g"}]
}
remove_client3_response = {
    "responses": [{"command": "removeGroupClient", "error": "Group name not valid UTF-8"}]
}

# No username
remove_client4_command = {"commands": [{"command": "removeGroupClient", "groupname": "g"}]}
remove_client4_response = {
    "responses": [{"command": "removeGroupClient", "error": "Invalid/missing username"}]
}

# Username not a string
remove_client5_command = {
    "commands": [{"command": "removeGroupClient", "groupname": "g", "username": 5}]
}
remove_client5_response = {
    "responses": [{"command": "removeGroupClient", "error": "Invalid/missing username"}]
}

# Username not UTF-8
remove_client6_command = {
    "commands": [{"command": "removeGroupClient", "groupname": "g", "username": "￿LO"}]
}
remove_client6_response = {
    "responses": [{"command": "removeGroupClient", "error": "Username not valid UTF-8"}]
}

# Group not found
remove_client7_command = {
    "commands": [
        {
...
remove_client7_response = {
    "responses": [{"command": "removeGroupClient", "error": "Group not found"}]
}

# Client not found
remove_client8_command = {
    "commands": [
        {
            "command": "removeGroupClient",
            "groupname": "validgroup",
...
remove_client8_response = {
    "responses": [{"command": "removeGroupClient", "error": "Client not found"}]
}
...
get_group3_response = {
    "responses": [{"command": "getGroup", "error": "Group name not valid UTF-8"}]
}
...
set_anon_group1_response = {
    "responses": [{"command": "setAnonymousGroup", "error": "Invalid/missing groupname"}]
}

# Groupname not a string
set_anon_group2_command = {"commands": [{"command": "setAnonymousGroup", "groupname": 5}]}
set_anon_group2_response = {
    "responses": [{"command": "setAnonymousGroup", "error": "Invalid/missing groupname"}]
}

# Groupname not UTF-8
set_anon_group3_command = {"commands": [{"command": "setAnonymousGroup", "groupname": "￿LO"}]}
set_anon_group3_response = {
    "responses": [{"command": "setAnonymousGroup", "error": "Group name not valid UTF-8"}]
}

# Group not found
set_anon_group4_command = {"commands": [{"command": "setAnonymousGroup", "groupname": "notfound"}]}
set_anon_group4_response = {
    "responses": [{"command": "setAnonymousGroup", "error": "Group not found"}]
}
...
modify_group1_response = {
    "responses": [{"command": "modifyGroup", "error": "Invalid/missing groupname"}]
}

# Group name not a string
modify_group2_command = {"commands": [{"command": "modifyGroup", "groupname": 5}]}
modify_group2_response = {
    "responses": [{"command": "modifyGroup", "error": "Invalid/missing groupname"}]
}

# Group name not UTF-8
modify_group3_command = {"commands": [{"command": "modifyGroup", "groupname": "￿LO"}]}
modify_group3_response = {
    "responses": [{"command": "modifyGroup", "error": "Group name not valid UTF-8"}]
}

# roles not a list
modify_group4_command = {
    "commands": [
        {
            "command": "modifyGroup",
            "groupname": "validgroup",
...
# No rolename
modify_group5_command = {
    "commands": [{"command": "modifyGroup", "groupname": "validgroup", "roles": [{}]}]
}
modify_group5_response = {
    "responses": [
        {
            "command": "modifyGroup",
            "error": "'roles' not an array or missing/invalid rolename",
...
# Group not found
modify_group8_command = {
    "commands": [{"command": "modifyGroup", "groupname": "notfound", "rolename": "notfound"}]
}
modify_group8_response = {"responses": [{"command": "modifyGroup", "error": "Group not found"}]}

# Role not found
modify_group9_command = {
    "commands": [
        {
            "command": "modifyGroup",
            "groupname": "validgroup",
