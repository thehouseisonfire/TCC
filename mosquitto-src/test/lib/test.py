...
tests = [
    ...
    (
        ...
        [
            ...
            "c/03-publish-b2c-qos1-unexpected-puback.test",
        ],
    ),
    ...
    (
        ...
        [
            ...
            "c/03-publish-b2c-qos2-unexpected-pubrel.test",
        ],
    ),
    (
        1,
        [
            ...
            "c/03-publish-b2c-qos2-unexpected-pubcomp.test",
        ],
    ),
    ...
    (
        ...
        [
            ...
            "c/03-publish-c2b-qos1-disconnect.test",
        ],
    ),
    ...
    (
        ...
        [
            ...
            "c/03-publish-c2b-qos1-receive-maximum.test",
        ],
    ),
    (
        1,
        [
            ...
            "c/03-publish-c2b-qos2-disconnect.test",
        ],
    ),
    ...
    (
        ...
        [
            ...
            "c/03-publish-c2b-qos2-maximum-qos-0.test",
        ],
    ),
    (
        1,
        [
            ...
            "c/03-publish-c2b-qos2-maximum-qos-1.test",
        ],
    ),
    (
        1,
        [
            ...
            "c/03-publish-c2b-qos2-pubrec-error.test",
        ],
    ),
    (
        1,
        [
            ...
            "c/03-publish-c2b-qos2-receive-maximum-1.test",
        ],
    ),
    (
        1,
        [
            ...
            "c/03-publish-c2b-qos2-receive-maximum-2.test",
        ],
    ),
    ...
    (
        ...
        [
            ...
            "c/03-request-response-correlation.test",
        ],
    ),
    ...
    (
        ...
        [
            ...
            "c/08-ssl-connect-cert-auth-custom-ssl-ctx.test",
        ],
    ),
    (
        1,
        [
            "./08-ssl-connect-cert-auth.py",
            "c/08-ssl-connect-cert-auth-custom-ssl-ctx-default.test",
        ],
    ),
    ...
    (
        ...
        [
            "./03-publish-c2b-qos1-disconnect.py",
            "cpp/03-publish-c2b-qos1-disconnect.test",
        ],
    ),
    (
        1,
        [
            "./03-publish-c2b-qos2-disconnect.py",
            "cpp/03-publish-c2b-qos2-disconnect.test",
        ],
    ),
