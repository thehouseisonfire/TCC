...
get_anon_group_none_command = {
    "commands": [{"command": "getAnonymousGroup", "correlationData": "2"}]
}
get_anon_group_none_response = {
    "responses": [
        {
...
get_anon_group_command = {"commands": [{"command": "getAnonymousGroup", "correlationData": "3"}]}
get_anon_group_response = {
    "responses": [
        {
            "command": "getAnonymousGroup",
...
delete_anon_group_command = {
    "commands": [{"command": "deleteGroup", "groupname": "anon-clients", "correlationData": "40"}]
}
delete_anon_group_response = {
    "responses": [
        {
            "command": "deleteGroup",
            "error": "Deleting the anonymous group is forbidden",
            "correlationData": "40",
        }
    ]
}
...
disconnect_packet_kick = mosq_test.gen_disconnect(
