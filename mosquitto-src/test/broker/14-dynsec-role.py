...
add_role_to_client_command = {
    "commands": [{"command": "addClientRole", "username": "user_one", "rolename": "basic"}]
}
add_role_to_client_response = {"responses": [{"command": "addClientRole"}]}

add_role_to_client2_command = {
    "commands": [{"command": "addClientRole", "username": "user_one", "rolename": "basic2"}]
}
add_role_to_client2_response = {"responses": [{"command": "addClientRole"}]}

add_role_to_group_command = {
    "commands": [{"command": "addGroupRole", "groupname": "group_one", "rolename": "basic"}]
}
add_role_to_group_response = {"responses": [{"command": "addGroupRole"}]}


list_roles_verbose_command1 = {
    "commands": [{"command": "listRoles", "verbose": True, "correlationData": "21"}]
}
list_roles_verbose_response1 = {
    "responses": [
        {
            "command": "listRoles",
            "data": {
...
list_roles_verbose_command2 = {
    "commands": [{"command": "listRoles", "verbose": True, "correlationData": "22"}]
}
list_roles_verbose_response2 = {
    "responses": [
        {
            "command": "listRoles",
            "data": {
...
list_clients_verbose_command = {
    "commands": [{"command": "listClients", "verbose": True, "correlationData": "20"}]
}
list_clients_verbose_response = {
    "responses": [
        {
            "command": "listClients",
            "data": {
                ...
                "clients": [
                    ...
                    },
                    {
                        ...
                        "textdescription": "Description",
                        "groups": [],
                        "roles": [{"rolename": "basic"}, {"rolename": "basic2"}],
                    },
                    {
                        "username": "user_two",
                        "textname": "Name",
...
list_groups_verbose_command = {
    "commands": [{"command": "listGroups", "verbose": True, "correlationData": "20"}]
}
list_groups_verbose_response = {
    "responses": [
        {
            "command": "listGroups",
            "data": {
...
remove_role_from_client_command = {
    "commands": [{"command": "removeClientRole", "username": "user_one", "rolename": "basic"}]
}
remove_role_from_client_response = {"responses": [{"command": "removeClientRole"}]}

remove_role_from_group_command = {
    "commands": [{"command": "removeGroupRole", "groupname": "group_one", "rolename": "basic"}]
}
